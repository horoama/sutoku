      ...
      return (
        <View key={item.id} className="relative overflow-hidden bg-primary p-4 rounded-lg text-on-primary shadow-lg flex-col mb-4">
          <View className="flex-row justify-between items-center mb-3">
            <View>
              <Text className="font-headline text-xl font-bold text-on-primary" numberOfLines={1}>{tItem(item.itemTemplate)}</Text>
            </View>
    ...
    return (
      <View key={item.id} className="bg-surface-container-lowest p-5 rounded-lg border-l-8 border-tertiary flex-row items-center gap-4 mb-4 shadow-sm">
        ...
        <View className="flex-1">
          <Text className="font-headline font-bold text-on-surface text-base" numberOfLines={1}>{tItem(item.itemTemplate)}</Text>
      ...
      >
        <View className="flex-row items-center gap-4 flex-1">
          ...
          <View className="flex-1 pr-2">
            <Text className="font-headline font-semibold text-on-surface text-base" numberOfLines={1}>{tItem(item.itemTemplate)}</Text>
  ...
  const renderPantryCard = (item: FridgeItem) => {
    return (
      ...
      >
        ...
        <View className="mb-2">
          <Text className="font-headline font-bold text-sm text-on-surface" numberOfLines={1}>{tItem(item.itemTemplate)}</Text>
